...
Partial Class SecuredSelf_SelfBenHousingApplication
    ...
    Protected Sub PopulateGrid()
        ...
        Try
            ...
            _dt = SQLHelper.ExecuteDataTable("EHousingApplication_WebSelf", UserNo, Generic.ToInt(cboTabNo.SelectedValue), PayLocNo)
    ...
    Private Function SaveRecord() As Boolean
        ...
        Dim EmployeeNo As Integer = Session("EmployeeNo")
        ...
        If SQLHelper.ExecuteNonQuery("EHousingApplication_WebSaveSelf", UserNo, Generic.ToInt(txtCode.Text), EmployeeNo, DateFiled, HousingTypeNo, Amount, Remarks, PayLocNo) Then
            SaveRecord = True
        Else
            SaveRecord = False
        End If
    ...
    Private Sub PopulateDropDown()
        ...
        'Try
        '    cboHousingTypeNo.DataSource = SQLHelper.ExecuteDataSet("EHousingType_WebLookup_Self", UserNo, Generic.ToInt(cboHousingTypeNo.SelectedValue), PayLocNo)
    ...
    Protected Sub lnkAttachment_Click(sender As Object, e As EventArgs)
        Dim lnk As New LinkButton
        lnk = sender
        Response.Redirect("~/securedSelf/frmFileUpload.aspx?id=" & Generic.Split(lnk.CommandArgument, 0) & "&display=" & Generic.Split(lnk.CommandArgument, 1))
    End Sub

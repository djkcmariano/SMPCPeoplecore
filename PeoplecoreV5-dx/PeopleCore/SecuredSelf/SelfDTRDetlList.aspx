<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="SelfDTRDetlList.aspx.vb" Inherits="Secured_DTRDetlList" Theme="PCoreStyle" %>
...
<script type="text/javascript">
    ...
    //	    function cbCheckAllMain_CheckedChanged(s, e) {d
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <ContentTemplate>                    
                    ...
                    <uc:ConfirmBox runat="server" ID="ConfirmBox2" TargetControlID="lnkSubmit" ConfirmMessage="Do you want to submit?"  />                                
                </ContentTemplate>
                <Triggers>

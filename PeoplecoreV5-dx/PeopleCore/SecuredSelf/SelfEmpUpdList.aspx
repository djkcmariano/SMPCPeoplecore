<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="SelfEmpUpdList.aspx.vb" Inherits="Secured_EmpUpdList" %>
    ...
    <asp:Panel id="Panel1" runat="server" CssClass="entryPopup" style="display:none">
        <fieldset class="form" id="fsMain">                    
            ...
            <div class="entryPopupDetl form-horizontal">                                                               
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label has-space">Shoe :</label>
                    <div class="col-md-4 has-padding">
                        <asp:Label runat="server" ID="lblShoeDesc_Old" />
                    </div>
                    <div class="col-md-4 has-padding">
                        <asp:Label runat="server" ID="lblShoeDesc" />
                    </div>                    
                </div> 
                <div class="form-group">
                    <label class="col-md-4 control-label has-space">T-Shirt :</label>
                    <div class="col-md-4 has-padding">
                        <asp:Label runat="server" ID="lblTShirtDesc_Old" />
                    </div>
                    <div class="col-md-4 has-padding">
                        <asp:Label runat="server" ID="lblTShirtDesc" />
                    </div>                    
                </div>                                                         
                <div class="form-group">

...
Partial Class Secured_PayMainDeductAdvList
    ...
    Dim TableName As String = "EPayMainDeductAdv"
    ...
    Private Sub PopulateGrid()
        Try
            ...
            '_dt = SQLHelper.ExecuteDataTable("EPayMainDeductAdv_Web", UserNo, tstatus, PayLocNo)
            ...
            End If
            'If IsNumeric(Me.cboPayMainDeductAdvIdNo.SelectedValue) = True Then
            '    BatchId = Generic.ToInt(Me.cboPayMainDeductAdvIdNo.SelectedValue)
            'End If
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("EPayMainDeductAdv_WebFiltered", UserNo, PayLocNo, Generic.ToInt(cboTabNo.SelectedValue), Filter1.SearchText, FilterByNo, FilterById, xMonth, xYear, Generic.ToStr(Me.txtDateFrom.Text), Generic.ToStr(Me.txtDateTo.Text), Generic.ToInt(PayDeductTypeNo), BatchId)
    ...
    Protected Sub cboPayMainDeductAdvIdNo_OnSelectedIndexChanged(sender As Object, e As EventArgs)
        PopulateGrid()
    End Sub
...
#Region "********Main*******"
    ...
    Protected Sub lnkDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete) Then
            Dim fieldValues As List(Of Object) = grdMain.GetSelectedFieldValues(New String() {"PayMainDeductAdvNo"})
            Dim str As String = ""
            For Each item As Integer In fieldValues
                RetVal = SQLHelper.ExecuteNonQuery("EPayMainDeductAdv_WebDelete_Indi", UserNo, CType(item, Integer))
                Generic.DeleteRecordAudit("EPayMainDeductAdv", UserNo, CType(item, Integer))
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        Try
            If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit) Then
                ...
                Dim obj As Object() = container.Grid.GetRowValues(container.VisibleIndex, New String() {"PayMainDeductAdvNo", "IsEnabled", "IsEnabled_Fields1", "IsEnabled_Fields2"})
                ...
                Dim dt As DataTable
                dt = SQLHelper.ExecuteDataTable("EPayMainDeductAdv_WebOne", UserNo, Generic.ToInt(i))
                ...
                Me.chkIsAdvarded.Enabled = IsEnabled_Fields2
                Me.chkIsSuspended.Enabled = IsEnabled_Fields2
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd) Then
            ...
            Dim tno As Integer = Generic.ToInt(Me.txtPayMainDeductAdvNo.Text)
            ...
            Dim IsAdvarded As Boolean = Generic.ToBol(Me.chkIsAdvarded.Checked)
            Dim IsSuspended As Boolean = Generic.ToBol(Me.chkIsSuspended.Checked)

            If SQLHelper.ExecuteNonQuery("EPayMainDeductAdv_WebSave", UserNo, tno, EmployeeNo, PayDeductTypeNo, Description, Amount, PayLocNo, 0, _
                                         PayScheduleNo, ApplicableYear, ApplicableMonth, StartDate, EndDate, EffectiveDate, IsSpecialPay, IsBonus, IsAdvarded, IsSuspended) > 0 Then
                Retval = True
            Else
                Retval = False
            End If
...
#Region "********Upload********"
    ...
    Protected Sub lnkUpload_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd) Then
            ...
            Response.Redirect("~/secured/PayMainDeductAdvList_Upload.aspx?id=0")
        Else
            MessageBox.Warning(MessageTemplate.DeniedAdd, Me)
        End If
    End Sub
    ...
    Protected Sub lnkSave2_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Dim IsAdvarded As Boolean = Generic.ToBol(Me.chkIsAdvarded2.Checked)
            ...
            If tProceed Then
                ...
                If d.Peek > -1 Then
                    ...
                    dty = SQLHelper.ExecuteDataTable("EPayMainDeductAdvId_WebSave", UserNo, Me.txtDescription2.Text, Me.cboPayDeductTypeNo2.SelectedValue, tfilename, PayScheduleNo, ApplicableYear, ApplicableMonth, StartDate, EndDate, IsSpecialPay, IsBonus, IsAdvarded, PayLocNo)
                ...
                While d.Peek() > -1
                    ...
                    If i > 0 Then
                        If employeeno > "" And rDesc > "" And rAmount <> 0 Then
                            ...
                            dtx = SQLHelper.ExecuteDataTable("EPayMainDeductAdv_WebUpload", UserNo, employeeno, CDbl(rAmount), Me.cboPayDeductTypeNo2.SelectedValue, rDesc, tfilename, PayLocNo, PayScheduleNo, ApplicableYear, ApplicableMonth, StartDate, EndDate, IsSpecialPay, IsBonus, IsAdvarded, BatchUploadId)
            ...
            'Try
            '    cboPayMainDeductAdvIdNo.DataSource = SQLHelper.ExecuteDataTable("EPayMainDeductAdvId_WebLookup", UserNo, Me.cboTabNo.SelectedValue)
            '    cboPayMainDeductAdvIdNo.DataTextField = "tdesc"
            '    cboPayMainDeductAdvIdNo.DataValueField = "tNo"
            '    cboPayMainDeductAdvIdNo.DataBind()
            'Catch ex As Exception
...
#Region "********Payment History********"
    ...
    Protected Sub lnkPayment_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            lnk = sender
            Dim container As GridViewDataItemTemplateContainer = TryCast(lnk.NamingContainer, GridViewDataItemTemplateContainer)
            Dim id As Integer = Generic.ToInt(container.Grid.GetRowValues(container.VisibleIndex, New String() {"PayMainDeductAdvNo"}))

            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("EPayMainDeductAdvPayment_Web", UserNo, id)

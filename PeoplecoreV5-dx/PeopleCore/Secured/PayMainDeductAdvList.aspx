<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="PayMainDeductAdvList.aspx.vb" Inherits="Secured_PayMainDeductAdvList" %>
                        ...
                        <ContentTemplate>
                            ...
                            <Content>
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="col-md-8">
                                        <asp:TextBox ID="txtDateFrom" runat="server" CssClass="form-control" CausesValidation="false" Placeholder="Effective Date From"
                                            ></asp:TextBox>
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="col-md-8">
                                        <asp:TextBox ID="txtDateTo" runat="server" CssClass="form-control" CausesValidation="false" Placeholder="Effective Date To"
                                            ></asp:TextBox>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="table-responsive">
                           <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="PayMainDeductAdvNo"
                           OnCommandButtonInitialize="grdMain_CommandButtonInitialize" OnCustomCallback="gridMain_CustomCallback">                                                                                   
                                <Columns>                            
                                    ...
                                    <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Payment">
                                        <DataItemTemplate>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="BatchNo" Caption="Batch No." />
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-7">
                    <asp:TextBox ID="txtPayMainDeductAdvNo" runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                </div>
            </div> 
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Effective Date :</label>
                <div class="col-md-3">                    
                    <asp:Textbox ID="txtEffectiveDate" runat="server" CssClass="form-control" placeholder="Effective Date" />
                    <ajaxToolkit:CalendarExtender ID="CalendarExtender7" runat="server" Format="MM/dd/yyyy" TargetControlID="txtEffectiveDate" />
                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender7" runat="server" Mask="99/99/9999" MaskType="Date" ClearTextOnInvalid="true" TargetControlID="txtEffectiveDate" />
                    <asp:CompareValidator runat="server" ID="CompareValidator5" ErrorMessage="<b>Please enter valid entry</b>" Operator="DataTypeCheck" Type="Date" Display="Dynamic" ControlToValidate="txtEffectiveDate" />                    
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-space">&nbsp;</label>
                <div class="col-md-7">                    
                    <asp:Checkbox ID="chkIsAdvarded" runat="server" Text="&nbsp;Tick here if deduction is Advarded (continuous deduction)." />
                </div>
            </div>
         ...
         <div  class="entryPopupDetl form-horizontal">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-space">&nbsp;</label>
                <div class="col-md-7">                    
                    <asp:Checkbox ID="chkIsAdvarded2" runat="server" Text="&nbsp;Tick here if deduction is Advarded (continuous deduction)." />
                </div>
            </div>
       ...
       <fieldset class="form" id="Fieldset2">
            <!-- Header here -->
             ...
             <div  class="container-fluid entryPopupDetl">                  
                <div class="table-responsive">
                    <dx:ASPxGridView ID="grdRate" ClientInstanceName="grdRate" runat="server" KeyFieldName="PayMainDeductAdvPaymentNo" Width="100%">
                        <Columns>                                
                            ...
                            <dx:GridViewDataTextColumn FieldName="GrossPay" Caption="Gross" PropertiesTextEdit-DisplayFormatString="{0:N2}" /> 
                            <dx:GridViewDataTextColumn FieldName="Amount" Caption="Amount" PropertiesTextEdit-DisplayFormatString="{0:N2}" />                                                                                                      
                        </Columns> 
                        <TotalSummary>

<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="BENLeaveBalanceList.aspx.vb" Inherits="Secured_BENLeaveBalanceList" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <ul class="panel-controls pull-left">
                                ...
                                <li >
                                    <asp:TextBox ID="txtDate"  SkinID="txtdate" runat="server" CssClass="form-control" AutoPostBack="true" OnTextChanged="lnkAsOff_Click" ></asp:TextBox>
                    ...
                    <div>
                        ...
                        <uc:Filter runat="server" ID="Filter1" EnableContent="true" Visible="false">
                        <Content>
                                <div class="form-group">
                        ...
                        <div class="table-responsive">
                           <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDXWOSearch" KeyFieldName="EmployeeNo">                                                                                   
                                <Columns>                            
                                    ...
                                    <%--<dx:GridViewDataTextColumn FieldName="HiredDate" Caption="Hired Date" />--%>
                        ...
                        <div class="table-responsive">
                           <dx:ASPxGridView ID="grdDetl1" ClientInstanceName="grdDetl1" runat="server" KeyFieldName="LeaveApplicationDetiNo" Width="100%">                                                                                   
                                <Columns>
                                    ...
                                    <%--<dx:GridViewDataTextColumn FieldName="EncodeDate" Caption="Date Applied" />--%> 
                                </Columns> 
                                <SettingsContextMenu Enabled="true">                                
                                    <RowMenuItemVisibility CollapseDetailRow="false" CollapseRow="false" DeleteRow="false" EditRow="false" ExpandDetailRow="false" ExpandRow="false" NewRow="false" Refresh="false" /> 
                                </SettingsContextMenu>                                                                                            
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:DropdownList ID="cboLeaveTypeno" CausesValidation="false" runat="server" CssClass="required form-control" AutoPostBack="true" OnSelectedIndexChanged="cboLeaveTypeno_SelectedIndexChanged">
                    </asp:DropdownList>
                 </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                     <asp:TextBox ID="txtAcquireDate" runat="server" CssClass="required form-control" AutoPostBack="true"  OnTextChanged="txtAcquireDate_TextChanged"> </asp:TextBox>
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Forfeited Date :</label>
                <div class="col-md-3">
            ...
            <div class="form-group" style="visibility:hidden;position:absolute;">
                ...
                <div class="col-md-7">
                   <asp:CheckBox ID="txtIsConsume" runat="server" Text="&nbsp; Tick if leave is for availment and not part of conversion."></asp:CheckBox>
                 </div>
            </div>

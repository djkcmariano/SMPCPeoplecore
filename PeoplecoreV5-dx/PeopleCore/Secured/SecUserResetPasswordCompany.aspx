<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="SecUserResetPasswordCompany.aspx.vb" Inherits="Secured_SecUserResetPasswordCompany" EnableEventValidation="false" %>
                        ...
                        <fieldset class="form" id="fsMain">
                                <div  class="form-horizontal">
                                    ...
                                    <div class="form-group" style="display:none">
                                         <label class="col-md-5 control-label has-space">Company Name :</label>
                                         <div class="col-md-7">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                             <asp:TextBox runat="server" ID="txtUserName" CssClass="form-control" style="display:inline-block;" placeholder="Type here..." AutoPostBack="true" OnTextChanged="txtUserName_TextChanged" /> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <asp:Textbox ID="txtPassword" ReadOnly="true" runat="server" CssClass="form-control default-cursor"></asp:Textbox>
                                        </div>
                                        <div class="col-lg-3">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-3 col-md-offset-5 pull-left">
                                                <asp:Button ID="Button1" Text="Generate Password" runat="server" CausesValidation="false" CssClass="btn btn-primary submit fsMain btnSave" ToolTip="Click here to save changes" OnClick="lnkGenerate_Click" ></asp:Button>
                                                <asp:Button ID="btnSave" Text="Save" runat="server" CausesValidation="false" CssClass="btn btn-primary submit fsMain btnSave" ToolTip="Click here to save changes" OnClick="lnkSave_Click" Visible="false" ></asp:Button>

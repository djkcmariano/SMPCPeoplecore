<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="PayMainDeductAdvList_Upload.aspx.vb" Inherits="Secured_PayMainDeductAdvList_Upload" %>
                    ...
                    <div class="table-responsive">
                        ...
                        OnCommandButtonInitialize="grdMain_CommandButtonInitialize" OnCustomCallback="gridMain_CustomCallback">
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="EncodedBy" Caption="Uploaded By" Visible="false"  />
                                <dx:GridViewDataTextColumn FieldName="EncodedDate" Caption="Date Uploaded" />
                                <%--<dx:GridViewDataTextColumn FieldName="HeadCount" Caption="Total<br/>Uploaded" PropertiesTextEdit-DisplayFormatString="{0:N0}" />--%>
                                <dx:GridViewDataTextColumn FieldName="tCount" Caption="Actual<br/>Count" PropertiesTextEdit-DisplayFormatString="{0:N0}" />
                                <%--<dx:GridViewDataTextColumn FieldName="DeletedCount" Caption="Manually<br/>Deleted" PropertiesTextEdit-DisplayFormatString="{0:N0}" />--%>
                                <%--<dx:GridViewDataTextColumn FieldName="Remarks" Caption="Remarks" />--%>
                                <%--<dx:GridViewDataTextColumn FieldName="DeletedByName" Caption="Deleted By" Visible="false" />--%>
                                <%--<dx:GridViewDataTextColumn FieldName="DeletedDate" Caption="Deleted Date" Visible="false" />--%>
        ...
        <fieldset class="form" id="fsMain">
            ...
            <div  class="entryPopupDetl form-horizontal">
                <div class="form-group">
                    <p class="col-md-12 control-label-left  has-space"><code><i class="fa fa-info-circle fa-lg"></i> File must be CSV (Comma delimited) with following columns and header: <br />EmployeeNo, DeductionCode, Description, Amount, EffectiveDate, SpecialPay (tag 0 or 1), Bonus (tag 0 or 1), Advarded (tag 0 or 1) </code></p>
                    <br />
                </div>
                <div class="form-group">

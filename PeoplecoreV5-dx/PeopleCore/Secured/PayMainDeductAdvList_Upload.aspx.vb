...
Partial Class Secured_PayMainDeductAdvList_Upload
    ...
    Dim FormName As String = "PayMainDeductAdvList.aspx"
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete, FormName, TableName) Then
            ...
            For Each item As Integer In fieldValues
                ...
                '******** Not Fixed **********'
                SQLHelper.ExecuteNonQuery("EPayMainDeductAdv_WebUpload_Delete", UserNo, item, PayLocNo)
                i = i + 1
            Next
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            If tProceed Then
                ...
                '******** Not Fixed **********'
                SQLHelper.ExecuteNonQuery("EPayMainDeductAdv_WebUpload_Delete", UserNo, BatchFileNo, PayLocNo)

                Dim dt As New DataTable
                Dim deducttypecode As String = ""
                ...
                While d.Peek() > -1
                    ...
                    If i > 0 Then
                        ...
                        IsBonus = fspecArr(6)
                        IsAdvarded = fspecArr(7)
                    End If

                    If i >= 1 Then
                        If employeeno.ToString > "" Then
                            dt = SQLHelper.ExecuteDataTable("EPayMainDeductAdv_WebUpload_BatchFile", UserNo, i, BatchFileNo, employeeno, deducttypecode, rDesc, CDbl(rAmount), rEffectiveDate, IsSpecialPay, IsBonus, IsAdvarded, PayLocNo)
                            For Each row As DataRow In dt.Rows

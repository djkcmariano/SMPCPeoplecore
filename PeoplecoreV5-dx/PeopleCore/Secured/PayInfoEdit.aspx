<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="PayInfoEdit.aspx.vb" Inherits="Secured_EmpEditInfo" %>
            ...
            <div  class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        ...
                        <ajaxToolkit:FilteredTextBoxExtender runat="server" ID="ftbe1" TargetControlID="txtSSSNo" FilterType="Custom" ValidChars="1234567890-" />
                    </div>
                    <div class="col-md-2">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label has-space">PhilHealth No. :</label>
                    <div class="col-md-2">
                        <asp:TextBox runat="server" ID="txtPHNo" CssClass="form-control" placeholder="PhilHealth No." />
                        <ajaxToolkit:FilteredTextBoxExtender runat="server" ID="ftbe2" TargetControlID="txtPHNo" FilterType="Custom" ValidChars="1234567890-" />
                    </div>
                    <div class="col-md-2">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label has-space">Pagibig No. :</label>
                    <div class="col-md-2">
                        <asp:TextBox runat="server" ID="txtHDMFNo" CssClass="form-control" placeholder="HDMF No." />
                        <ajaxToolkit:FilteredTextBoxExtender runat="server" ID="ftbe3" TargetControlID="txtHDMFNo" FilterType="Custom" ValidChars="1234567890-" />
                    </div>
                    <div class="col-md-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <asp:TextBox runat="server" ID="txtEmployeeHDMF" CssClass="form-control number" />
                    </div>                  
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label has-space">Pagibig Employer Share :</label>
                    <div class="col-md-6">
                        <asp:TextBox runat="server" ID="txtEmployerHDMF" CssClass="form-control number" />
                    </div>                  
                </div>       
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        ...
                        <ajaxToolkit:FilteredTextBoxExtender runat="server" ID="ftbe4" TargetControlID="txtTinNo" FilterType="Custom" ValidChars="1234567890-" />
                    </div>
                    <div class="col-md-2">
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-md-6">
                        <asp:CheckBox runat="server" ID="chkIsRata" Text="&nbsp;Tick if eligible for RA" />
                    </div>           
                </div> 
                <div class="form-group"> 
                    <label class="col-md-3 control-label has-space"></label>
                    <div class="col-md-6">
                        <asp:CheckBox runat="server" ID="chkIsTA" Text="&nbsp;Tick if eligible for TA" />
                    </div>               
                </div> 

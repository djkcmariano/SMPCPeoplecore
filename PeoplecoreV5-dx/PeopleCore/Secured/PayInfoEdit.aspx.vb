...
Partial Class Secured_EmpEditInfo
    ...
    Protected Sub btnModify_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit, Generic.ToStr(Session("xFormName")), Generic.ToStr(Session("xTableName"))) Then
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit, Generic.ToStr(Session("xFormName")), Generic.ToStr(Session("xTableName"))) Then
            ...
            dtx = SQLHelper.ExecuteDataTable("EPayInfo_WebValidate", UserNo, TransNo, PayClassNo, PayTypeNo, PaymentTypeNo, TaxExemptNo, EmployeeRateClassNo, BankTypeNo, BankAccountNo, SSSNo, _
                                        ...
                                        OrienteeStartDate, OrienteeEndDate, ProbeStartDate, ProbeEndDate, HiredDate, RehiredDate, RegularizedDate, SeparatedDate, SuspendedDate, BlacklistedDate, PFEE, IsPFPaNoByER, IsDontDeductPF, IsRata, IsTA)
            ...
            If Retval Then
                Dim url As String = "PayInfoEdit.aspx?id=" & TransNo

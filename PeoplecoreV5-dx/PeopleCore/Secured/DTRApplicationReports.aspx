<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="DTRApplicationReports.aspx.vb" Inherits="Secured_DTRApplicationReports" %>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <asp:DropDownList runat="server" ID="cboReportTypeNo" CssClass="form-control required">
                                            ...
                                            <asp:ListItem Value="1" Text="00000001 - Leave" />
                                            <asp:ListItem Value="2" Text="00000002 - OT" />
                                            <asp:ListItem Value="3" Text="00000003 - OB" />
                                            <asp:ListItem Value="4" Text="00000004 - DTR Correction" />
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <asp:DropDownList runat="server" ID="cboPayClassNo" CssClass="form-control required"> </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group">

<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="EmpHRANEdit.aspx.vb" Inherits="Secured_EmpHRANEdit" %>
    ...
    <script type="text/javascript">
        ...
        function SalaryPermission() {
            ...
            if (IsSalaryAdjust == true) {
                ...
                document.getElementById('<%=cboHRANCorrectedNo.ClientID%>').disabled = false;
            } else {
                document.getElementById('<%=txtCurrentSalary.ClientID%>').disabled = true;
                document.getElementById('<%=cboHRANCorrectedNo.ClientID%>').disabled = true;
            }
            ...
            if (IsViewSalary == true) {
                ...
                if (IsEditSalary == true) {
                    ...
                    $('#pHRANCorrected').removeAttr("style");
                } else {
                    $('#pcurrentsalary').css({ 'display': 'none' });
                    $('#pHRANCorrected').css({ 'display': 'none' });
                }
            } else {
                $('#pcurrentsalary').css({ 'display': 'none' });
                $('#pHRANCorrected').css({ 'display': 'none' });
        ...
        function SetContextKey() {
            var IsActive = document.getElementById('<%=txtIsActive.ClientID%>').checked;
            var IsApplicant = document.getElementById('<%=txtIsApplicant.ClientID%>').checked;
            var IsSeparated = document.getElementById('<%=txtIsSeparated.ClientID%>').checked;

            if (IsActive == true) {
                $find('<%=AutoCompleteExtenderHRAN.ClientID%>').set_contextKey("3");
            } else if (IsApplicant == true) {
                $find('<%=AutoCompleteExtenderHRAN.ClientID%>').set_contextKey("1");
            } else if (IsSeparated == true) {
                $find('<%=AutoCompleteExtenderHRAN.ClientID%>').set_contextKey("2");
            }
        };
                ...
                <fieldset class="form" id="fsd">
                        <div  class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:TextBox ID="txtHRANCode" runat="server" Enabled="false" CssClass="form-control" Placeholder="Autonumber"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <label class="radio-inline">
                                        <asp:RadioButton ID="txtIsActive" GroupName="hStatus" Text="&nbsp; Active Employees " runat="server" onclick="OnChangeRadio(this)"  />
                                    </label>
                                    <label class="radio-inline">
                                        <asp:RadioButton ID="txtIsSeparated" GroupName="hStatus" Text="&nbsp; Separated Employees " runat="server" onclick="OnChangeRadio(this)" />
                                    </label>
                                    <label class="radio-inline">
                                        <asp:RadioButton ID="txtIsApplicant" GroupName="hStatus" Text="&nbsp; Applicant Pooling" runat="server" onclick="OnChangeRadio(this)" />
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:TextBox runat="server" ID="txtFullName"  onkeyup="SetContextKey()" onblur="ResetEmployee()" CssClass="form-control required" Placeholder="Type here..."/> 
                                    <asp:HiddenField runat="server" ID="hifEmployeeNo" OnValueChanged="hifEmployeeNo_ValueChanged" />
                                    <asp:HiddenField runat="server" ID="hifcurrentsalary"/>
                                    <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtenderHRAN" runat="server"  
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                function getEmployee(source, eventArgs) {
                                                    ...
                                                    document.getElementById('<%= cboPositionNo.ClientID %>').value = SplitH(eventArgs.get_value(), 6);
                                                    ...
                                                    document.getElementById('<%= hifcurrentsalary.ClientID %>').value = SplitH(eventArgs.get_value(), 33);
                                                    //alert(document.getElementById('<%= hifcurrentsalary.ClientID %>').value);
                                                    var EmployeeId = SplitH(eventArgs.get_value(), 0);
                                                   // __doPostBack(EmployeeId, "");

                                                    /// document.getElementById('<%= txtCurrentSalary.ClientID %>').value = Session["cursalary"]
                                                    //document.getElementById('<%= txtCurrentSalary.ClientID %>').value = document.getElementById('<%= hifcurrentsalary.ClientID %>').value
//                                                   
                                                }
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label has-space">Plantilla Number :</label>
                                <div class="col-md-6" >        
                            ...
                            <div class="form-group" style="display:none">
                                ...
                                <div class="col-md-6" >                                    
                                    <asp:TextBox runat="server" ID="txtPositionDescS" CssClass="form-control" onblur="ResetPosition()" Placeholder="Type here..." /> 
                                    ...
                                    <ajaxToolkit:AutoCompleteExtender ID="acePosition" runat="server"  
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function getRecordS(source, eventArgs) {
                                                ...
                                                document.getElementById('<%= cboJobGradeNo.ClientID %>').value = SplitH(eventArgs.get_value(), 2);
                                                document.getElementById('<%= cboEmployeeClassNo.ClientID %>').value = SplitH(eventArgs.get_value(), 3);
                                            }                               	
                             ...
                             <div class="form-group" style="display:none">
                                ...
                                <div class="col-md-6">
                                    <asp:ListBox ID="lstPlantilla" runat="server" SelectionMode="Single" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="lstPlantilla_SelectedIndexChanged">
                                    </asp:ListBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:DropDownList ID="cboEmployeeClassNo" DataMember="EEmployeeClass" runat="server" CssClass="form-control required"></asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label has-space" runat="server" id="lblEI">Exit Interview Template :</label>
                                <div class="col-md-6">
                                    <asp:DropdownList ID="cboApplicantStandardHeaderNo" runat="server" CssClass="form-control" />                                                                                                        
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:DropDownList ID="cboEmployeeRateClassNo" DataMember="EEmployeeRateClass" runat="server" CssClass="form-control required"></asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="pcurrentsalary" style="display:none;">
                                <label class="col-md-3 control-label has-space">Basic Salary :</label>
                                <div class="col-md-2">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label has-space"></label>
                                <div class="col-md-6">
                                    <asp:CheckBox ID="chkxIsNot201" runat="server" Enabled="false" Text="&nbsp;HRAN Type is defined not to effect this transaction in 201."></asp:CheckBox>
                                </div>
                            </div>

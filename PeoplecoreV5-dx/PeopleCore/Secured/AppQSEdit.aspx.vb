...
Partial Class Secured_AppQSEdit
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        Dim dt1 As DataTable = SQLHelper.ExecuteDataTable("EApplicantQS_WebSave", UserNo, Generic.ToInt(txtCode.Text), TransNo, Generic.ToInt(cboQSTypeNo.SelectedValue), Generic.ToInt(cboQSNo.SelectedValue), "", 0, 0)
        ...
        Try
            ...
            If response.IsSuccessful Then
                ...
                arr(0)("ApplicantQSNo") = jsonData.Id
                json = arr.ToString(Newtonsoft.Json.Formatting.None)
                SQLHelper.ExecuteNonQuery("EJSONMain_WebSave", json, "EApplicantQS")
                RetVal = True
            Else
                RetVal = False
